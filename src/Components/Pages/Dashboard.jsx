...
const Dashboard = () => {
  ...
  const stockFull = React.useMemo(() => [], []);
  const stockRisk = React.useMemo(() => [], []);
  ...
  const pharDashboard = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        const stockMap = response.stockMap || {};
        ...
        const percentageData = values.map(v =>
          ...
          <div className="row">
            <div className="col-lg-8 col-md-6 col-sm-12 mb-3">
              <div className="new-mega-card">
                <div className="admn-title mb-3 d-flex align-items-center justify-content-between flex-wrap">
                  <div>
